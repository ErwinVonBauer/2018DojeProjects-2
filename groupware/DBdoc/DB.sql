...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='결재';
...
INSERT INTO `approval` VALUES (3,6,4,2,2,1,'2018-05-31 02:17:26',1,'휴가결재1'),(4,6,3,1,1,1,'2018-05-31 06:36:24',1,'두번째결재'),(5,10,3,1,1,6,'2018-05-31 06:57:10',1,'두번째결재'),(6,11,3,1,1,7,'2018-06-07 02:30:02',1,'2018/2분기결과결재');
...
CREATE TABLE `approvalline` (
  ...
  PRIMARY KEY (`apl_ai`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='결재라인';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `approvalline` VALUES (1,'테스트용결재라인입니다','첫결재','첫 결재라인'),(5,'이준용,기획부,대리\r\n이번 결재 담당자입니다','두번째결재라인','간단한두번째결재라인'),(6,'관리자,총무부,사원','세번째결재라인','3번째결재라인'),(7,'관리자,총무부,사원\r\n이번 대리결재 담당자입니다. 확인 부탁드립니다','2018/2분기결재라인','20180630폐기예정라인');
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='문서작성(기안)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `draft` VALUES (6,1,1,1,'휴가보내주세요-수정됨','<p>&nbsp;</p><p>제목이곧내용-수정되었어요l</p>\r\n	\r\n	\r\n	\r\n	','report',0,1),(10,4,2,2,'휴가문서2','<p>두번째 휴가문서</p>','vacation',0,1),(11,5,1,1,'2018년 2분기 결산보고서','<p>이번 2분기 우리 회사 실적이 나쁩니다.. ㅠㅠ 더 열심히 해야할듯!</p><p><img src=\"/imgs/20180607112344.jpg\"><br style=\"clear:both;\">&nbsp;</p>\r\n	','report',0,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='유저';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,1,1,'test1234','1234','이준용','2018-04-04 08:33:28'),(2,1,1,'ljlj','','이ㅑㅐ','2018-04-09 23:38:55'),(3,1,1,'admin','1234','관리자','2018-04-19 04:42:14'),(4,2,2,'test1','1234','이준용','2018-05-09 08:02:00'),(5,1,1,'test','1234','에르빈','2018-06-07 02:21:13');
...
-- Dump completed on 2018-06-07 15:34:07
