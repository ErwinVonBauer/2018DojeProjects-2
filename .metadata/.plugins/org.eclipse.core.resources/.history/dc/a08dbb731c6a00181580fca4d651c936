...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='문서작성(기안)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='유저';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,1,1,'test1234','1234','이준용','2018-04-04 08:33:28'),(2,1,1,'ljlj','','이ㅑㅐ','2018-04-09 23:38:55');
...
-- Dump completed on 2018-04-11 10:31:59
